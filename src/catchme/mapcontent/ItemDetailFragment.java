...
public class ItemDetailFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*if (getArguments() != null) {
			...
			mItem = ExampleContent.ITEM_MAP.get(ItemListFragment.lastChoosedContactId);
		}*/
	...
	public void updateView(long id) {
		...
		if (id < 0) {
			Toast.makeText(getActivity(), "TODO! "+id+" "+mItem, 0).show();
			((TextView) rootView.findViewById(R.id.item_detail)).setText("TODO");
